...
export interface EffectTrigger<T extends SimEvent = SimEvent> {
  ...
  /**
   * Deferred execution: if true, the trigger action is NOT executed immediately
   * when the event fires. Instead it's collected and executed after the current
   * frame's main event processing completes (including all cascading events).
   *
   * Use for "xx后" (after X) game descriptions: the effect fires after the
   * triggering hit/action fully completes, not as an inserted mid-hit resolution.
   *
   * Default: false (immediate execution, inserted into the current resolution chain).
   */
  deferred?: boolean;
...
export interface EffectSnapshot {
  ...
  /** Serialized triggers; required for round-trip through events / clone. */
...
export class Effect {
  ...
  static ElementCryo() {
    return new Effect({
      id: "ELEMENT_CRYO",
      tags: ["ELEMENT_ATTACH", "ELEMENT_CRYO"],
  ...
  static ElementHeat() {
    return new Effect({
      id: "ELEMENT_HEAT",
      tags: ["ELEMENT_ATTACH", "ELEMENT_HEAT"],
  ...
  static ElementElectric() {
    return new Effect({
      id: "ELEMENT_ELECTRIC",
      tags: ["ELEMENT_ATTACH", "ELEMENT_ELECTRIC"],
  ...
  static ElementNature() {
    return new Effect({
      id: "ELEMENT_NATURE",
      tags: ["ELEMENT_ATTACH", "ELEMENT_NATURE"],
